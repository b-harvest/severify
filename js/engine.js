...
const SeverifyEngine = {
  ...
  generateExport(state) {
    ...
    if (state.impactOverride) {
      data.impact.override = {
        score: state.impactOverride.score,
        level: state.impactOverride.level.label,
        justification: state.impactOverride.justification,
      };
    }
  ...
  toMarkdown(exportData) {
    ...
    if (exportData.impact.override) {
      lines.push(`- **Override**: ${exportData.impact.override.score} (${exportData.impact.override.level})`);
      if (exportData.impact.override.justification) {
        lines.push(`- **Override Justification**: ${exportData.impact.override.justification}`);
      }
    }
    ...
    if (exportData.likelihood.override) {
      ...
      if (exportData.likelihood.override.justification) {
